...
export class MailService {
  ...
  constructor() {
    ...
    this.transporter = nodemailer.createTransport({
      ...
      tls: {
        rejectUnauthorized: false, // Evitar que los certificados inválidos causen errores
      },
    });
  }
  ...
  async sendReservationemail(email: string, name: string): Promise<void> {
    ...
    <body style="font-family: Arial, sans-serif; background-color: #f0f4ff; margin: 0; padding: 20px; display: flex; justify-content: center; align-items: center; min-height: 100vh; box-sizing: border-box;">
      <div style="background-color: #ffffff; max-width: 600px; width: 100%; padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); text-align: center;">
        ...
        <a href="https://front-hotel-app-six.vercel.app/ style="display: inline-block; margin-top: 20px; padding: 10px 20px; background-color: #7f69b9; color: white; text-decoration: none; border-radius: 5px; font-size: 16px;">Ir a Home</a>
        <p style="color: #666666; margin-top: 20px;">Si no puedes hacer click en el botón, visita este link <a href="https://front-hotel-app-six.vercel.app/ style="color: #5120cc; text-decoration: none;">siguiente enlace</a></p>
      </div>
